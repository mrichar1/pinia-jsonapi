...
describe('getRelated', function () {
  let jsonWidget1, jsonWidget2, jsonWidget3, normWidget1, normWidget2, normWidget3, store
  ...
  test('should use existing rel info in the object passed in.', async function () {
    ...
    expect(res).to.deep.equal({ widgets: { 2: normWidget2 } })
  })
  ...
  test('should return related data for a specific relname', async function () {
    ...
    expect(res).to.deep.equal({ widgets: { 1: normWidget1 } })
  })
